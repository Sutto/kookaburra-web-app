...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.markdown", "Rakefile", "lib/merb-exceptions", "lib/merb-exceptions/default_exception_extensions.rb", "lib/merb-exceptions/exceptions_helper.rb", "lib/merb-exceptions/notification.rb", "lib/merb-exceptions/templates", "lib/merb-exceptions/templates/email.erb", "lib/merb-exceptions.rb", "spec/default_exception_extensions_spec.rb", "spec/exceptions_helper_spec.rb", "spec/notification_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
